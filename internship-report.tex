...
Through the setup of our Test Laboratory Environment, we managed to adapt those formal Test Cases in a reproducible manner, to be able to recreate the same conditions and reach the same results over time. More specifically, our results showed that the tested Libraries are \textbf{secure} from the Transport Layer Security perspective.

Furthermore, the developed Test Suite and Laboratory Environment enables us for future monitoring of the TLS security requirements of new versions of the tested libraries, or of additional Libraries altogether.
