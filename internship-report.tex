...
\lstinputlisting[language=Python]{alterCommonName.py}
...
\lstinputlisting[language=Python]{alterExpirationDate.py}
The script uses the `\textbf{pyasn1}' , `\textbf{pyasn1\_modules}' and `\textbf{sys}' libraries to:
\begin{enumerate}
...
\lstinputlisting[language=Python]{alterPublicKey.py}
