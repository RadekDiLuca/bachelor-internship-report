...
\chapter{Conclusion}
MQTT is a protocol which, inherently to its lightweight nature, has little security measures. Therefore it needs to rely on the Transport Layer Security protocol much more than other Application Level protocols such as SFTP and SMP.
